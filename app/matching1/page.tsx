...
const pawPrintImages: MatchItem[] = [
  {
    name: 'Beaver',
    image: '/Beaver Paw.jpeg',
  },
  {
    name: 'Vancouver Wolf',
    image: '/Vancouver Wolf Paw.jpg',
  },
  {
    name: 'Spirit Bear',
    image: '/Spirit bear paw.jpg',
  },
]
...
export default function MatchingGame() {
  ...
  return (
    <main className="min-h-screen bg-green-100 flex flex-col items-center p-6 text-center">
        ...
        <div className="flex flex-col gap-10 items-center">
          ...
          {animalImages.map((animal) => (
            <div key={animal.name} className="flex items-center gap-4">
              <div className="w-32 h-32 bg-white border-2 border-green-500 rounded-lg shadow-md flex items-center justify-center relative">
                <Image
                  src={animal.image}
                  alt={animal.name}
                  width={128}
